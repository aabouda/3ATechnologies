...
public interface IprojectService {
	...
	/**
	 * This Method allowed to add a new Project to the DataBase.
	 * It will compare sysDate() with the start date of the project to switch project state to "finished" or "" or ""
	 * @param projet
	 */
